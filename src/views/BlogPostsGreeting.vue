<template>
  <div class="blog-posts-greeting">
    ...
    <h2>
      Here you can find all the blog posts that have been published by our authors. Click on any of
      them to read more.
    </h2>
...
async function loadBlogPosts() {
  try {
    ...
    console.log('faield to fetch Blog posts', error)
  }
}

function goToRandomBlogPost() {
  if (blogPosts.value.length === 0) {
    alert('no blog post available.')
    return
  }
